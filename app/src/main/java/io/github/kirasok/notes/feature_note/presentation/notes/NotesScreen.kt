...
import io.github.kirasok.notes.feature_note.presentation.notes.components.NoteItem
import io.github.kirasok.notes.feature_note.presentation.notes.components.OrderSection
...
fun NotesScreen(
  ...
  Scaffold(
    floatingActionButton = {
      FloatingActionButton(
        onClick = { navController.navigate(Screen.EditorScreen.route) },
